<div class="row">
            <div class="col-md-12 mb-3">
              ...
              <div class="col-md-12 mb-3">
                <label for="transactionID">Please complete with the transaction id/hash*:</label>
                  <input type="text" class="form-control" name="transactionID" id="transactionID" placeholder="" value="" required>
              </div>
