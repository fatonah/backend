...
<head>
    ...
    <title>{{ __('Reset Secret Pin') }}</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
						...
						<p></p>
                        <h5 class="font-medium m-b-20">{{ __('Reset Secret Pin') }}</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
						 @include('partials.errors')
                            ...
                            <form method="POST" action="{{ route('submit.resetpin') }}">
                        @csrf


                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">{{ __('New Secret Pin') }}</span>
                                    </div>
                                    <input id="secretpin" type="text" class="form-control" name="secretpin" required autofocus>
                                    <input id="token" type="hidden" class="form-control" value="{{$token}}" name="token" required autofocus>
