                    ...
                    <div class="row">
                        <div class="col-12">
						 @include('partials.errors')
                            ...
                            <form method="POST" action="{{ route('submit.reset') }}">
                        @csrf
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">{{ __('Confirmation Password') }}</span>
                                    </div>
                                    <input id="confirmed" type="password" class="form-control" name="confirmed" required autofocus>
