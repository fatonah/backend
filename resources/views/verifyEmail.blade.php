    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                <img src="{{asset('asset/assets/images/logo-icon.png')}}">
                <h4 class="text-dark font-24">{{settings('title')}}</h4>
                <div class="m-t-30">
                    <h3>{{$mesej}}</h3>
                    <h5 class="m-b-0 text-muted font-medium">Thank you for reloading this page.</h5>
