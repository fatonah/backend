...
/////////////////////////////////////////////////////////////////////
///  LIST LABEL CHANNEL LIGHTNING WALLET         ///////////////////////////////////////
////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
///  LIST CLOSED CHANNEL LIGHTNING WALLET         ///////////////////////////////////////
////////////////////////////////////////////////////////////////////
...
function openchanlightning001($peers, $localsat, $pushsat){
    ...
    foreach ($allpeers['peers'] as $peer) {
        $pb[] = $peer['pub_key'];
    }

    if(in_array($peerspub, $pb, true)){
        $allchan = $lnrest->getAllChannels();
        foreach ($allchan as $chan) {
            $i = 0;
            foreach ($chan as $c) {
    ...
    if(!in_array($peerspub, $remotepub, true)){
        // $lnrest->openChannel($peerspub, $localsat, $pushsat);
        // return $peerspub;
        $status = $lnrest->openChannel($peerspub, $localsat, $pushsat);
        return $status;
    }
    else{
