...
function getbalance($crypto, $label) {
    ...
    elseif($crypto == 'BCH'){
        $wallet_balance = bitcoind()->client('bitabc')->getbalance($label)->get();
        return $wallet_balance;
    }
    elseif($crypto == 'DASH'){
...
////////////////////////////////////////////////////////////////////
function sendtoaddressRAW($crypto, $sendlabel, $recvaddress, $cryptoamount, $memo) {
    if ($crypto == 'BTC'){
    ...
    elseif ($crypto == 'BCH') {
        ...
        $total =  number_format(($cryptoamount+$estfee+$pxfee), 8, '.', '');
        $addressarr = bitcoind()->client('bitabc')->getaddressesbyaccount($sendlabel)->get();
        dd(
            $balance,
            $estfee,
            $total,
